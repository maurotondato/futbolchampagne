...
-- ---------------------------------------------------------------------
insert into players (name, favorite_position, phone) values
  ('Mariano Alcuaz', 'ARQ', '2223428916'),
  ('German Fiordelli', 'DEF', '2223431407'),
  ('Mauri Fiordelli', 'DEF', '2223674209'),
  ('Ezequiel Jaime', 'DEF', '2223534574'),
  ('Nico Leoni', 'DEF', '2223464220'),
  ('Marcos Llanos', 'MED', '2223432496'),
  ('Juan M Muñoz', 'MED', '1132361413'),
  ('Jonas Manso', 'MED', '2223574213'),
  ('Manu Mendizabal', 'MED', '2216208746'),
  ('Mateo Manso', 'MED', '2223502767'),
  ('Franco Nieto', 'DEL', '2223464183'),
  ('Natalio Napolitani', 'DEL', '1155829579'),
  ('Rodrigo Olivera', 'DEL', '2223513781'),
  ('Pablo Piazza', 'DEL', '2223461938'),
  ('Ramiro Rey', 'ARQ', '2223428304'),
  ('Augusto Rossi', 'DEF', '2223504190'),
  ('Marcos Rivaletto', 'MED', '2223463198'),
  ('Fede Sargiotti', 'DEL', '2223511073'),
  ('Matias Yornet', 'MED', '2223505173'),
  ('Mario Llanos', 'DEF', '2223425586'),
  ('Santi Cupparo', 'DEL', '2223463681'),
  ('Beto', 'DEF', '2223433889'),
  ('Toto Cardozo', 'MED', '2223490648'),
  ('Mauro Tondato', 'DEL', '2223431190')
